...
@section('breadcumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Rata - rata</li>
        </ol>
        <h6 class="font-weight-bolder mb-0">Rata - rata</h6>
    </nav>
@endsection
@section('content')
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <a class="btn bg-gradient-primary d-inline-flex me-md-2 " href="/ratarata/cetak">
                            ...
                            <tbody>
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        {{--  <td>
                                            <p class="text-xs font-weight-bold mb-0">{{ $item->quiz->quiz }}</p>
