                ...
                <div class="card-body px-2 py-2 pt-0 pb-2">
                    <div class="table-responsive p-2">
                        <table class="table align-items-center mb-0">
                            <form action="/updatesoal/{{$data->id}}" method="post">
                                @csrf
                                @method('PUT')
                                <table class="table table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" >
                                                <input type="number" class="form-control " id="no" name="no" value="{{$data->no}}" >
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <select class="form-control" id="jawaban" name="jawaban">
                                                <option {{old('jawaban') ? '' : 'selected disabled'}}value="{{$data->jawaban}}">{{$data->jawaban}}</option>
