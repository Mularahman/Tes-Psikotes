                        ...
                        <div class="col-xl-5 col-lg-6 col-md-6 d-flex flex-column mx-auto">
                            ...
                            <div class="card card-plain mt-1 mb-6 bg-white shadow">
                                <div class="card-header pb-0 text-left bg-white">
                                    <h3 class="font-weight-bolder text-center text-success text-gradient">Sign in</h3>
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form action="/loginuser" method="POST" class="mt-2">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex justify-content-between align-items-top mb-3">
                                                ...
                                                <div><a href="{{ route('forget.password.get') }}" class="small text-right">Lost password?</a></div>
                                            </div>
                                        </div>
