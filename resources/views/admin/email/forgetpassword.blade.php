...
<body style="word-spacing:normal;background-color:#EBEBEE;">
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:30px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Playfair Display, Time News Roman, Serif;font-size:30px;font-weight:Bold;line-height:1;text-align:center;color:#020939;"><h1>Forget Password Email</h1>

                            You can reset password from bellow link:
                            <a href="{{ route('reset.password.get', $token) }}">Reset Password</a></div>
                      </td>
                    </tr>
                  </tbody>
                </table>
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:0px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Assistant, Helvetica, arial, sans-serif;font-size:18px;line-height:1;text-align:center;color:#9799AB;">2022 Company Copyright All Rights Reserved.</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
