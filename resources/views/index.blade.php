      ...
      <div class="container py-7 postion-relative z-index-2 position-relative">
        <div class="row">
          <div class="col-md-7 mx-auto text-center">
            ...
            <h2 class="text-gradient text-dark mb-4">Workflow</h2>
            <p class="text-white mb-5">Peserta tes dapat diberikan akses tes yang berbeda-beda. Tes dapat
                dilakukan secara individual maupun klasikal (massal)</p>

          </div>
        </div>
        <div class="row">
            <div class="col-6 col-md-3 mt-4  text-center">
                <div class="icon icon-shape bg-gradient-light shadow-lg rounded mb-4">
                    <svg class="icon icon-md text-dark" fill="currentColor" viewBox="0 0 20 20"
                ...
                <p class="fw-bolder">Step 1</p>
                <h3 class="text-gray">Registrasi</h3>
            </div>
            <div class="col-6 col-md-3 mt-4  text-center">
                <div class="icon icon-shape bg-gradient-light shadow-lg rounded mb-4">
                    <svg class="icon icon-md text-dark" fill="currentColor" viewBox="0 0 20 20"
                ...
                <p class="fw-bolder">Step 2</p>
                <h3 class="text-gray">Pilih Tes</h3>
            </div>
            <div class="col-6 col-md-3 mt-4  text-center ">
                <div class="icon icon-shape bg-gradient-light shadow-lg rounded mb-4">
                    <svg class="icon icon-md text-dark" fill="currentColor" viewBox="0 0 20 20"
                ...
                <p class="fw-bolder">Step 3</p>
                <h3 class="text-gray">Pelaksanaan Tes</h3>
            </div>
            <div class="col-6 col-md-3 mt-4  text-center ">
                <div class="icon icon-shape bg-gradient-light shadow-lg rounded mb-4">
                    <svg class="icon icon-md text-dark" fill="currentColor" viewBox="0 0 20 20"
                ...
                <p class="fw-bolder">Step 4</p>
                <h3 class="text-gray">Hasil Tes</h3>
            </div>
        </div>
      </div>
    </div>
...
<section class="py-7" id="mulai">
    <div class="container">
      <div class="row pb-5">
        <div class="col-lg-12 mx-auto text-center ">
          <h2 class="mb-0">Menu Aplikasi Psikotes Online</h2>
          <p class="lead px-lg-8">Sebelum memulai tes, agar peserta login terlebih dahulu. Jika belum
            memiliki akun, silahkan registrasi terlebih dahulu. </p>
        </div>
      </div>
      ...
      {{--  <div class="row mt-6">
        ...
        <div class="col-lg-4 col-md-8 ms-md-auto">
          <div class="card bg-gradient-success move-on-hover">
            <div class="card-body ">
                <a href="/" class="col-md-6 col-lg-4 mt-4 pb-3 mt-lg-0 mt-md-0 mb-3 page-preview scale-up-2">
                    <div class="d-flex flex-column h-100 pt-3 text-center shadow-soft  rounded mb-4">
                        <div class="px-3 px-lg-4 py-5 text-center">
                            ...
                            <p class="text-dark">Tes untuk menguji kemampuanmu dalam penalaran tentang angka. Tes ini akan memperkirakan
                                tingkat IQ-mu</p>
                            <div class="mt-auto">

                                <h5 class="fw-bold text-white">Kerjakan Tes <svg xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="row">
                @foreach ($quizuser as $item )
                @if ($item->status == 0)
                <a href="/{{$item->quiz->slug}}" class="col-md-6 col-lg-4 mt-4 pb-3 mt-lg-0 mt-md-0 mb-3 move-on-hover">
                    <div class="card bg-gradient-success d-flex flex-column h-100 pt-3 text-center shadow-soft text-white rounded mb-4">
                        <div class="px-3 px-lg-4 py-5 text-center">
                            ...
                            <p class="text-dark">{{$item->quiz->deskripsi}}</p>
                            <div class="mt-auto">

                                <h5 class="fw-bold text-light">Kerjakan Tes <svg xmlns="http://www.w3.org/2000/svg"
                                    width="20" height="20" fill="currentColor"
                                    class="bi bi-chevron-double-right" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd"
                                        d="M3.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L9.293 8 3.646 2.354a.5.5 0 0 1 0-.708z" />
                ...
                @else
                <a href="/hasil/{{$item->quiz->token}}" class="col-md-6 col-lg-4 mt-4 pb-3 mt-lg-0 mt-md-0 mb-3 move-on-hover">
                    <div class="card bg-gradient-success d-flex flex-column h-100 pt-3 text-center shadow-soft text-white rounded mb-4">
                        <div class="px-3 px-lg-4 py-5 text-center">
                            <h3 class=" fw-bold mb-4 text-light">
                            ...
                            <p class="text-dark">{{$item->quiz->deskripsi}}</p>
                            <div class="mt-auto">
                                <h5 class="fw-bold text-light">Lihat Hasil <svg xmlns="http://www.w3.org/2000/svg"
                                    width="20" height="20" fill="currentColor"
                                    class="bi bi-chevron-double-right" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd"
                                        d="M3.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L9.293 8 3.646 2.354a.5.5 0 0 1 0-.708z" />
            ...
            @foreach ($quizuser as $user )
            @if (auth()->id()==$user->user_id)
            <div class="justify-content-center mb-5 mb-lg-6 {{ auth()->id() == $user->user_id ?'d-none' : ''}}">
            @else
                <div class="justify-content-center mb-5 mb-lg-6 ">
            @endif
            @endforeach
                    <a href="/" class="">
                        <div class="card bg-gradient-success d-flex flex-column h-100 pt-3 text-center shadow-soft text-white rounded mb-4">
                            <div class="px-3 px-lg-4 py-5 text-center">
                                <h3 class=" fw-bold mb-4 text-light">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-mortarboard-fill" viewBox="0 0 16 16">
                                        ...
                                        Tes Psikotes Tidak Tersedia Untuk Saat Ini !
                                </h3>
                                <p class="text-dark" >“ Menu tes akan muncul sesuai hak akses dari admin. “</p>
                                <div class="mt-auto">
                                    <h5 class="fw-bold text-light">Hubungi Admin <svg xmlns="http://www.w3.org/2000/svg"
                                            width="20" height="20" fill="currentColor"
                                            class="bi bi-chevron-double-right" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd"
                                                d="M3.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L9.293 8 3.646 2.354a.5.5 0 0 1 0-.708z" />
